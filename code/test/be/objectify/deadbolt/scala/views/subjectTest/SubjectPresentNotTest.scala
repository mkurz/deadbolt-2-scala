...
import be.objectify.deadbolt.scala.views.html.subjectTest.{subjectNotPresentContent, subjectNotPresentOrContent}
 ...
 */
class SubjectPresentNotTest extends PlaySpecification {
