...
/**
  ...
  */
class Pattern @Inject()(deadbolt: DeadboltActions, controllerComponents: ControllerComponents) extends AbstractController(controllerComponents) with AbstractPattern {
